...
async def auth_payload(client: AsyncClient, email: str, password: str | None = None) -> RefreshToken:
...
async def auth_headers(client: AsyncClient, email: str, password: str | None = None) -> dict[str, str]:
